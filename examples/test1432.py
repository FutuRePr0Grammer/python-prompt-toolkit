...
from prompt_toolkit.widgets import menus
...
root_container = MenuContainer(
    ...
    menu_items=[
            ...
            children=[
                ...
                MenuItem("Time/Date",
                         children=[
                             MenuItem("Find"),
                             MenuItem("Hide"),
                             MenuItem("Today's Date",
                                      children=[
                                          MenuItem(menus.get_time())
                                      ])
                         ]
                         ),
            ],
        ...
        MenuItem("Date and Time",
                 children=[MenuItem("Current Time", children=[MenuItem(menus.get_time())]),
                           MenuItem("Open Clock For Date and Time", handler=open_clock)])
    ],
    floats=[
        Float(
            xcursor=True,
